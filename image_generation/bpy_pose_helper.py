...
def get_calibration_matrix_K_from_blender(camd):
    ...
    sensor_size_in_mm = get_sensor_size(camd.sensor_fit, sensor_width_in_mm, sensor_height_in_mm)
    ...
    print("focal: {}, res_x: {}, res_y: {}, scale: {}, sensor_W: {}, \
        sensor_H: {}, fit: {}, aspect: {}, s_u: {}, s_v: {}".format(
    f_in_mm, resolution_x_in_px, resolution_y_in_px, scale, sensor_width_in_mm,
    sensor_height_in_mm, camd.sensor_fit, pixel_aspect_ratio, s_u, s_v))
    return K
...
# adapted from httphttps://blender.stackexchange.com/questions/882/how-to-find-image-coordinates-of-the-rendered-vertex?lq=1
